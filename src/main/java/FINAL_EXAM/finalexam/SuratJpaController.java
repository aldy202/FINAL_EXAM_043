...
import FINAL_EXAM.finalexam.exceptions.NonexistentEntityException;
import FINAL_EXAM.finalexam.exceptions.PreexistingEntityException;
...
public class SuratJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("FINAL_EXAM_finalexam_jar_0.0.1-SNAPSHOTPU");
